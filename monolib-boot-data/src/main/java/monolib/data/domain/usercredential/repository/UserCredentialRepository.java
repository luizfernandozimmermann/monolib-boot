...
import monolib.data.domain.usercredential.model.UserCredentialBaseRepository;
...
@Repository
public interface UserCredentialRepository extends UserCredentialBaseRepository {
