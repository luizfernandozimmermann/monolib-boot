...
@Component
public abstract class EntityReadController<E extends EntityBase, D extends EntityDtoBase> extends EntityControllerBase<E, D> {
    ...
    public Page<Map<String, Object>> list(@Valid EntityPageable input) {
        ...
        return getRepository().findAll(specificationFactory.create(input.getFilter(), input.getOrderBy()), pageable)
